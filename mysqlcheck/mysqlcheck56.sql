...
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME like '%sql_uuid%'\G
...
SELECT '</tr>'\G
SELECT CONCAT_WS('','<tr><td class=y>',Host,'</td><td>',User,'</td></tr>') from mysql.user\G
SELECT '</table>'\G
...
select CONCAT_WS('','<tr><td class=x>','Connections','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Connections'\G
select CONCAT_WS('','<tr><td class=x>','Max_used_connections','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Max_used_connections'\G
select CONCAT_WS('','<tr><td class=y>','table_open_cache','</td><td>',@@table_open_cache,'</td></tr>')\G
select CONCAT_WS('','<tr><td class=x>','Open_tables','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Open_tables'\G
select CONCAT_WS('','<tr><td class=x>','Opened_tables','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Opened_tables'\G
select CONCAT_WS('','<tr><td class=y>','open_files_limit','</td><td>',@@open_files_limit,'</td></tr>')\G
select CONCAT_WS('','<tr><td class=x>','Open_files','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Open_files'\G
select CONCAT_WS('','<tr><td class=x>','Opened_files','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Opened_files'\G
select CONCAT_WS('','<tr><td class=y>','binlog_cache_size','</td><td>',@@binlog_cache_size,'</td></tr>')\G
select CONCAT_WS('','<tr><td class=x>','Binlog_cache_use','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Binlog_cache_use'\G
select CONCAT_WS('','<tr><td class=x>','Binlog_cache_disk_use','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Binlog_cache_disk_use'\G
select CONCAT_WS('','<tr><td class=y>','binlog_stmt_cache_size','</td><td>',@@binlog_stmt_cache_size,'</td></tr>')\G
select CONCAT_WS('','<tr><td class=x>','Binlog_stmt_cache_use','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Binlog_stmt_cache_use'\G
select CONCAT_WS('','<tr><td class=x>','Binlog_stmt_cache_disk_use','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Binlog_stmt_cache_disk_use'\G
select CONCAT_WS('','<tr><td class=y>','thread_cache_size','</td><td>',@@thread_cache_size,'</td></tr>')\G
select CONCAT_WS('','<tr><td class=x>','Threads_cached','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Threads_cached'\G
select CONCAT_WS('','<tr><td class=x>','Threads_connected','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Threads_connected'\G
select CONCAT_WS('','<tr><td class=x>','Table_locks_immediate','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Table_locks_immediate'\G
select CONCAT_WS('','<tr><td class=x>','Table_locks_waited','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Table_locks_waited'\G
SELECT '</table>'\G
...
select CONCAT_WS('','<tr><td class=x>','Created_tmp_disk_tables','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Created_tmp_disk_tables'\G
select CONCAT_WS('','<tr><td class=x>','Created_tmp_tables','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Created_tmp_tables'\G
SELECT '</table>'\G
...
SELECT '<th width="200">Value</th>'\G
SELECT '</tr>'\G
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME like '%log_bin%'\G
SELECT CONCAT_WS('','<tr><td class=y>','sync_binlog','</td><td>',@@sync_binlog,'</td></tr>')\G
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME like '%binlog_order_commits'\G
SELECT CONCAT_WS('','<tr><td class=y>','binlog_format','</td><td>',@@binlog_format,'</td></tr>')\G
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME like '%binlog_checksum'\G
...
SELECT '<th width="200">Value</th>'\G
SELECT '</tr>'\G
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME like '%gtid_%' and VARIABLE_NAME not in ('gtid_executed','gtid_purged')\G
SELECT '</table>'\G
...
select CONCAT_WS('','<tr><td class=x>','Qcache_hits','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Qcache_hits'\G
select CONCAT_WS('','<tr><td class=x>','Qcache_inserts','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Qcache_inserts'\G
select CONCAT_WS('','<tr><td class=x>','Qcache_queries_in_cache','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Qcache_queries_in_cache'\G
select CONCAT_WS('','<tr><td class=x>','Qcache_free_blocks','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Qcache_free_blocks'\G
select CONCAT_WS('','<tr><td class=x>','Qcache_lowmem_prunes','</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME='Qcache_lowmem_prunes'\G
SELECT '</table>'\G
...
SELECT '<th width="200">Value</th>'\G
SELECT '</tr>'\G
select CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td width="200" style="word-break:break-all">',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME like '%optimize%'\G
SELECT '</table>'\G
...
SELECT '<li><a style="color:#663300" href="#305">3.5  Innodb Trx Lock</a></li>'\G
SELECT '<li><a style="color:#663300" href="#306">3.6  Innodb Engine Stauts</a></li>'\G
SELECT '</ul>'\G
SELECT '<hr />'\G
...
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME='innodb_io_capacity_max'\G
SELECT CONCAT_WS('','<tr><td class=y>','innodb_lock_wait_timeout','</td><td>',@@innodb_lock_wait_timeout,'</td></tr>')\G
SELECT CONCAT_WS('','<tr><td class=x>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME like 'Innodb_buffer_pool_read%'\G
SELECT '</table>'\G
...
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME='innodb_page_size'\G
SELECT '</table>'\G
...
SELECT '<th width="200">Value</th>'\G
SELECT '</tr>'\G
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME='innodb_undo_directory'\G
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME='innodb_max_undo_log_size'\G
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME='innodb_undo_tablespaces'\G
SELECT '</table>'\G

SELECT '<a name="305"></a>'\G
SELECT '<h2>3.5 Innodb Trx Lock</h2>'\G
SELECT '<table border="1px" bordercolor="#000000" cellspacing="0px" style="border-collapse:collapse">'\G
SELECT '<tr>'\G
...
SELECT '<h2>3.6 Innodb Engine Stauts</h2>'\G
SELECT '<table border="1px" bordercolor="#000000" cellspacing="0px" style="border-collapse:collapse">'\G
SELECT '<tr>'\G
...
SELECT '<th width="200">Value</th>'\G
SELECT '</tr>'\G
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME like '%relay%'\G
SELECT '</table>'\G
...
SELECT '<th width="200">Value</th>'\G
SELECT '</tr>'\G
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME like '%rpl%'\G
SELECT CONCAT_WS('','<tr><td class=x>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME like '%rpl%'\G
SELECT '</table>'\G
...
SELECT '<th width="200">Value</th>'\G
SELECT '</tr>'\G
SELECT CONCAT_WS('','<tr><td class=y>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_variables where VARIABLE_NAME like '%group_rep%'\G
SELECT CONCAT_WS('','<tr><td class=x>',VARIABLE_NAME,'</td><td>',VARIABLE_VALUE,'</td></tr>') from information_schema.global_status where VARIABLE_NAME like '%group_rep%'\G
SELECT '</table>'\G
